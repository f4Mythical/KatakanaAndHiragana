...
public class RegisterDialogFragment extends DialogFragment {
    ...
    private String sprawdzPoprawnoscHasla(String hasloUzytkownika) {
        ...
        podpowiedz.append(ma6Znakow ? "✅" : "❌").append(" 6+znaków ");
        podpowiedz.append(maCyfre ? "✅" : "❌").append(" Cyfra ");
        podpowiedz.append(maWielkaLitere ? "✅" : "❌").append(" Wielka ");
        podpowiedz.append(maMalaLitere ? "✅" : "❌").append(" Mała");
